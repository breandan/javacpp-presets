...
/* Version as a string */
public static final String PY_VERSION =              "3.8.0";
/*--end constants--*/
...
@NoException public static native void _PyNode_FinalizeEndPos(node n);  // helper also used in parsetok.c
...
@NoException public static native @ByVal PyStatus _Py_InitializeFromArgs(
    @Const PyConfig config,
    @Cast("Py_ssize_t") long argc,
    @Cast("char*const*") PointerPointer argv);
@NoException public static native @ByVal PyStatus _Py_InitializeFromArgs(
...
@NoException public static native @ByVal PyStatus _Py_InitializeFromArgs(
    ...
    @Cast("Py_ssize_t") long argc,
    @Cast("char*const*") @ByPtrPtr byte[] argv);
@NoException public static native @ByVal PyStatus _Py_InitializeFromWideArgs(
    @Const PyConfig config,
    @Cast("Py_ssize_t") long argc,
    @Cast("wchar_t*const*") PointerPointer argv);
@NoException public static native @ByVal PyStatus _Py_InitializeFromWideArgs(
